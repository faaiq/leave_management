...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{!! asset('public/theme/vendor/plugins/iCheck/square/blue.css') !!}">
...
<!-- iCheck -->
<script src="{!! asset('public/theme/vendor/plugins/iCheck/icheck.min.js') !!}"></script>
<script>
  $(function () {
    $('input').iCheck({
